...
public class Error implements Serializable {
    ...
    public Map<String, Object> handlePaymentProcessingException(PaymentProcessingException ex) {
        Map<String, Object> errors = new HashMap<>();
        errors.put("Erro", "Erro no processamento do pagamento: " + ex.getMessage());
        errors.put("Codigo", HttpStatus.BAD_REQUEST.value());
        return errors;
    }
}